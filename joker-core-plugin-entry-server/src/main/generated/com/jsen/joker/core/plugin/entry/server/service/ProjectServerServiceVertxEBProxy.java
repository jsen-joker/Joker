...
public class ProjectServerServiceVertxEBProxy implements ProjectServerService {
  ...
  public ProjectServerServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public ProjectServerServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void saveFile(String artifactId, String groupId, String version, String data, String className, String name, String uuid, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _json.put("artifactId", artifactId);
    _json.put("groupId", groupId);
    _json.put("version", version);
    _json.put("data", data);
    _json.put("className", className);
    _json.put("name", name);
    _json.put("uuid", uuid);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "saveFile");
  ...
  public void download(String fileName, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "download");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void listAll(Handler<AsyncResult<List<JsonObject>>> resultHandler) {
    ...
    JsonObject _json = new JsonObject();
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "listAll");
