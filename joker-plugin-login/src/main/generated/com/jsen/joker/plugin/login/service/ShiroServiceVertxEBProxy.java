...
public class ShiroServiceVertxEBProxy implements ShiroService {
  ...
  public ShiroServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public ShiroServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void getRoleByUserId(Integer id, Handler<AsyncResult<List<SysRole>>> resultHandler) {
    ...
    _deliveryOptions.addHeader("action", "getRoleByUserId");
      ...
      if (res.failed()) {
        ...
        resultHandler.handle(Future.succeededFuture(res.result().body().stream()
            .map(o -> { if (o == null) return null;
                        return o instanceof Map ? new SysRole(new JsonObject((Map) o)) : new SysRole((JsonObject) o);
                 })
  ...
  public void getPermissionByRoleId(Integer id, Handler<AsyncResult<List<SysPermission>>> resultHandler) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getPermissionByRoleId");
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
        resultHandler.handle(Future.succeededFuture(res.result().body().stream()
            .map(o -> { if (o == null) return null;
                        return o instanceof Map ? new SysPermission(new JsonObject((Map) o)) : new SysPermission((JsonObject) o);
                 })
            .collect(Collectors.toList())));
      }
    });
  ...
  public void deleteByName(String name, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _json.put("name", name);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "deleteByName");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void listUser(int page, int capacity, Handler<AsyncResult<List<SysUser>>> resultHandler) {
    ...
    JsonObject _json = new JsonObject();
    _json.put("page", page);
    _json.put("capacity", capacity);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "listUser");
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
        resultHandler.handle(Future.succeededFuture(res.result().body().stream()
            .map(o -> { if (o == null) return null;
                        return o instanceof Map ? new SysUser(new JsonObject((Map) o)) : new SysUser((JsonObject) o);
                 })
            .collect(Collectors.toList())));
      }
    });
  ...
  public void getUserByName(String name, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _json.put("name", name);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getUserByName");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
