package com.jsen.test.gateway;

import com.jsen.test.common.RestVerticle;
import com.jsen.test.common.VerticleBase;
import com.jsen.test.common.config.ConfigRetrieverHelper;
import com.jsen.vertx.account.UserVerticle;
import com.jsen.vertx.account.service.UserService;
import com.jsen.vertx.account.service.impl.UserServiceImpl;
import com.jsen.vertx.account.utils.TokenUtils;
        ...
        circuitBreaker.execute(future -> {
            getAllEndpoints().setHandler(ar -> {
                if (ar.succeeded()) {
                    ...
                    String newPath = path.substring(initialOffset + prefix.length() - 1);
